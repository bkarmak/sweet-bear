...
public class BooksProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            //	Log.d("HERE","QUERY ID SEARCK");
                ...
                break;
            case BOOKS:
            	//Log.d("HERE","QUERY ID BOOKS");
                qb.setTables("books");
                break;
            case BOOK_ID:
            	//Log.d("HERE","QUERY ID BOOKID");
                qb.setTables("books");
    ...
    public String getType(Uri uri) {
        switch (URI_MATCHER.match(uri)) {
            case BOOKS:
                return "vnd.android.cursor.dir/vnd.com.wanhu.provider.shelves";
            case BOOK_ID:
                return "vnd.android.cursor.item/vnd.com.wanhu.provider.shelves";
            default:
                throw new IllegalArgumentException("Unknown URI " + uri);
        }
    }
