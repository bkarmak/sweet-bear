...
public final class IOUtilities {
	...
	public static OnPublishProgress mOnPublishProgress;
	 ...
	 */
	public static void copy(InputStream in, OutputStream out, long pLength)
			throws IOException {
		int lenghtOfFile = (int) pLength;
		...
		while ((read = in.read(b)) != -1) {
			if (mOnPublishProgress != null) {
				total += read;
				mOnPublishProgress.onPublisthProgress(""
